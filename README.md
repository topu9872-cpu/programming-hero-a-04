...
getElementById get specific element  , getElementsByClassName get specific all elements, 
querySelector get fast tag name that we want , querySelectorAll get all same tag name or all same class name
### 2. How do you create and insert a new element into the DOM?
document.createElement('any tag name that we want').
